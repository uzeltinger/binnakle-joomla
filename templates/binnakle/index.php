        ...
        <div class="link-juegos link-juegos-mobile">
          <div class="nuestro-serius-game-mobile">
            <a class="juego_theexpedition_open_submenu link-juego <?php if (JRequest::getInt('Itemid') == 108) {
                                                                    echo ' active';
                                                                  } ?>" href="./binnakle-the-expedition.html">BINNAKLE<br>THE EXPEDITION</a>
            <ul class="serious-games-submenu dropdown-menu juego_theexpedition_submenu">
              <li class="nav-item item-conocer"><a href="/binnakle-the-expedition.html">Conocer</a></li>
          ...
          <div class="nuestro-serius-game-mobile last">
            <a class="juego_mission0_open_submenu link-juego link-juego-last <?php if (JRequest::getInt('Itemid') == 109) {
                                                                                echo ' active';
                                                                              } ?>" href="./binnakle-mission-0.html">BINNAKLE<br>MISSION 0</a>
            <ul class="serious-games-submenu dropdown-menu juego_mission0_submenu">
              <li class="nav-item item-conocer"><a href="/binnakle-mission-0.html">Conocer</a></li>
              <li class="nav-item item-112"><a href="#">Comprar</a></li>
              <li class="nav-item item-112"><a href="#">Jugar</a></li>
          </div>
        </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="resultado col-6 col-sm-4 col-lg-3">
                ...
                <div class="bajada">
                  <p>IMPULSAR LA <br>CO-CREACIÓN</p>
                </div>
              </div>
              <div class="resultado col-6 col-sm-4 col-lg-3">
        ...
        <div class="footer-fondos d-none d-lg-block">
          <div class="container">
            ...
            <div class="row">
              <div class="col-12">
                <div class="footer-info">
                  <h3>¿Cómo puedo utilizar Binnakle en mi empresa?</h3>
                  <p>Comprando partidas on-line, o vía los partners oficiales de Binnakle.</p>
                  <p>
                    También puedes comprar on-line una maleta de Binnakle The Expedition.</p>
                  <p>Formando a facilitadores internos vía webinars o presencialmente, a través de un partner oficial de Binnakle.</p>
                  <p>Contratando a un partner oficial de Binnakle para que venga a dinamizar sesiones o eventos.</p>
                </div>
              </div>
            </div>
          </div>
